...
export default async function Home() {
  return (
    <div className="space-y-4 py-4">
      <Header />
      <main className="mx-auto w-full max-w-[1200px] space-y-8 min-h-screen flex flex-col px-4">
        {/* Apresentação */}
        ...
        <section className="flex flex-col md:flex-row justify-center gap-4">
          <a
            href="/doctors"
            className="w-full md:w-auto px-6 py-3 bg-primary text-white font-medium rounded-lg shadow hover:bg-primary-dark transition"
          >
            Conheça nossos médicos
          </a>
          <a
            href="/chat"
            className="w-full md:w-auto px-6 py-3 bg-secondary text-white font-medium rounded-lg shadow hover:bg-secondary-dark transition"
          >
            Chat com Médico
          </a>
          <a
        ...
        {/* Destaques */}
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-6">
